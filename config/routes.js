...
module.exports.routes = {
  ...
  'GET /markets/m25': { action: 'pages/m25' },
  'GET /api/markets/m25': { action: 'markets/m25' },
  'GET /markets/m30': { action: 'pages/m30' },
  ...
  'GET /markets/m50': { action: 'pages/m50' },
  ...
  'GET /summary/:ticker': { action: 'summary/show'},
  'GET /api/summary/:ticker': { action: 'summary/fetch'},
